    ...
    return {
        ...
        phaseList: [{
            ...
            phases: [
                ...
                { id: Phase.Input_Detail_LayerNorm, title: '层规范化 Layer Norm' },
                { id: Phase.Input_Detail_SelfAttention, title: '自注意力 Self Attention' },
                { id: Phase.Input_Detail_Projection, title: '投影 Projection (投影)' },
